...
## Part 5: Policies, Profiles & Testing

> Split from `AGENTS.md` to avoid context-window truncation.
> Original: lines 1128–1356. Full guide = AGENTS-core + AGENTS-architecture + AGENTS-plugins-skills + AGENTS-agents-systems + AGENTS-policies-testing.
