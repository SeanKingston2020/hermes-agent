...
## Part 3: Plugins, Skills & Extensibility

> Split from `AGENTS.md` to avoid context-window truncation.
> Original: lines 644–980. Full guide = AGENTS-core + AGENTS-architecture + AGENTS-plugins-skills + AGENTS-agents-systems + AGENTS-policies-testing.
